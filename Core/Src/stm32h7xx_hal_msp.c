...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C2)
  {
    ...
    PF1     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(ICP20100_SDA_GPIO_Port, ICP20100_SDA_Pin);

    HAL_GPIO_DeInit(ICP20100_SCL_GPIO_Port, ICP20100_SCL_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI2)
  {
    ...
    PA9     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, SPI2_MISO_ICM_Pin|SPI2_MOSI_ICM_Pin);

    HAL_GPIO_DeInit(SPI2_SCK_ICM_GPIO_Port, SPI2_SCK_ICM_Pin);
