...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    PC11     ------> SPI3_MISO
    */
    HAL_GPIO_DeInit(SPI3_MOSI_SENSOR3_BMI088_GPIO_Port, SPI3_MOSI_SENSOR3_BMI088_Pin);

    HAL_GPIO_DeInit(GPIOC, SPI3_SCK_SENSOR3_BMI088_Pin|SPI3_MISO_SENSOR3_BMI088_Pin);
